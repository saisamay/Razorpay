...
async def verify():
    async with async_playwright() as p:
        ...
        print("Navigating Desktop to http://127.0.0.1:5173/operations")
        await page.goto("http://127.0.0.1:5173/operations", wait_until="networkidle")
        await asyncio.sleep(2)

        # Desktop Screenshot
        desktop_shot = os.path.join(ARTIFACTS_DIR, "operations_desktop_3b.png")
        ...
        print("Navigating Tablet to http://127.0.0.1:5173/operations")
        await page_tablet.goto("http://127.0.0.1:5173/operations", wait_until="networkidle")
        await asyncio.sleep(2)

        tablet_shot = os.path.join(ARTIFACTS_DIR, "operations_tablet_3b.png")
        ...
        evidence_path = os.path.join(ARTIFACTS_DIR, "operations_evidence_3b.json")
